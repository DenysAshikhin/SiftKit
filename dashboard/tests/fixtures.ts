...
export const MANAGED_PRESET = {
  ...
  NumCtx: 4096, GpuLayers: 0, Threads: 4, NcpuMoe: 0, FlashAttention: false, VisionEnabled: false, ParallelSlots: 1, BatchSize: 512, UBatchSize: 512, CacheRam: 2048, CacheRecurrentRam: 4096,

...
export const MANAGED_PRESET = {
  ...
  NumCtx: 4096, NcpuMoe: 0, VisionEnabled: false, VisionOffload: false, VisionImageRetention: 8, VisionMaxImagePixels: 0, ParallelSlots: 1, UBatchSize: 512, CacheRam: 2048, CacheRecurrentRam: 4096, NgramRam: false,

  ...
  return (
    <div className="assistant-config-groups">
      ...
      <Group title="Observation">
        ...
        <NumberField label="Fixed cadence minutes" value={assistant.Observation.FixedCadenceMinutes} min={1} onChange={(FixedCadenceMinutes) => onChange({ ...assistant, Observation: { ...assistant.Observation, FixedCadenceMinutes } })} />
        ...
        <NumberField label="Minimum perceptual distance" value={assistant.Observation.MinimumPerceptualDistance} min={0} onChange={(MinimumPerceptualDistance) => onChange({ ...assistant, Observation: { ...assistant.Observation, MinimumPerceptualDistance } })} />

    ...
    <div id="mp-body" className={preset.Backend === 'exl3' ? 'exl3' : undefined}>
      ...
      {group('identity-launch', (
        <>
          ...
          {!preset.ExternalServerEnabled ? renderField('model-presets', 'Executable path', (
          ...
          {!preset.ExternalServerEnabled ? renderField(
            'model-presets',
            preset.Backend === 'exl3' ? 'Model directory (EXL3)' : 'Model path (.gguf)',
            (
              <div className="settings-live-nav-control">
                <input
      ...
      {group('speculative', (
        <>
          ...
          {speculativeEnabled ? renderField('model-presets', 'Speculative type', (

...
const TARGETS = [
  ...
  'src/status-server/routes/operations.ts',
  'src/status-server/routes/repo-agent.ts',
  'src/status-server/routes/repo-search.ts',
  'src/status-server/routes/server-admin.ts',
  'src/status-server/routes/status-post.ts',

...
test('a fresh database is created at v35 without the backend column', () => {
  ...
  assert.equal(schemaVersion(dbPath), 35);
});

test('v31 migration drops the legacy backend column before advancing to v35', () => {

...
$commandScript = "Start-Sleep -Milliseconds 150; Write-Output 'cmd-2 stdout'"
...
[ordered]@{ Token='cmd-2'; ExitCode=$result.ExitCode; RawLogPath=$result.RawLogPath; ReducedLogPath=$result.ReducedLogPath } | ConvertTo-Json -Compress -Depth 5

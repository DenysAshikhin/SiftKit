...
$commandScript = "Start-Sleep -Milliseconds 150; Write-Output 'cmd-4 stdout'"
...
[ordered]@{ Token='cmd-4'; ExitCode=$result.ExitCode; RawLogPath=$result.RawLogPath; ReducedLogPath=$result.ReducedLogPath } | ConvertTo-Json -Compress -Depth 5

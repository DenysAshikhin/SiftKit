...
const limits: FunctionLimit[] = [
  ...
  { filePath: 'src/status-server/routes/status-post.ts', symbol: 'StatusPostEndpoint.handle', maxLines: 90 },
  { filePath: 'src/status-server/routes/status-post.ts', symbol: 'StatusPostRequestHandler.handle', maxLines: 90 },
  { filePath: 'src/status-server/routes/status-post.ts', symbol: 'StatusPostRequestHandler.updateStatusMetrics', maxLines: 90 },

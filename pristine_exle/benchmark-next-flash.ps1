...
#& 'C:\envs\rl313-turbo\Scripts\python.exe' "$env:PYTHONPATH\eval\perf.py" --model_dir 'D:\personal\models\elx3\td_flash-next_4.05bpw_h6_ng6' --moe_cpu_split 410 --moe_cpu_threads 12 --max_length 32768 --chunk_size 2048 -ngr

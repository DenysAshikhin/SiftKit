...
'C:/envs/rl313-turbo/Scripts/python.exe' $S/logits_check.py --save $S/logits_new.pt \
  -m 'D:/personal/models/elx3/td_flash-next_4.05bpw_h6_ng6' -mcs 410 -mct 12 -cs 32768 > $S/logits_new2.log 2>&1
echo "logits check exit $?"; tail -3 $S/logits_new2.log
R=$S/run2.sh

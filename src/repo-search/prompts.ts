...
export function buildTaskSystemPrompt(repoRoot: string, options?: {
  ...
  return [
    ...
    'Finish: {"action":"finish","output":"<anchor-bullets>","confidence":0.0-1.0}.',
    '',
    ...
    '{"action":"finish","output":"src/config.ts:42 — definition; src/summary.ts:120-135 — call site","confidence":0.93}',
    '',
    'Forbidden:',

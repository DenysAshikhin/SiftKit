...
export function formatCompactJsonBlock(values: JsonValue[]): string {
  return values.map((value) => JSON.stringify(value)).join('\n');
}

export function formatPlannerToolResultHeader(value: JsonObject): string | null {
...
export function formatPlannerResult(value: OptionalJsonValue): string {

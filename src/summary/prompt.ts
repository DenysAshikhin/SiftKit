...
export const PROMPT_PROFILES: Record<SummaryPolicyProfile, string> = {
  general: [
...
export function getSourceInstructions(
  sourceKind: SummarySourceKind,
  commandExitCode: number | null | undefined
): string {
...
export function extractPromptSection(prompt: string, header: string): string {
...
export function appendChunkPath(

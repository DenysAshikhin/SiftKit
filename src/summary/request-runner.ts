  ...
  private async notifyModelCompletion(
    ...
    await notifySummaryTerminalStatus({
      ...
      deferredMetadata: {
        ...
        promptEvalDurationMs: summaryCore.completionMetrics?.promptEvalDurationMs ?? null,
        generationDurationMs: summaryCore.completionMetrics?.generationDurationMs ?? null,
        throughput: summaryCore.completionMetrics?.throughput ?? null,
    ...
    if (this.config !== null) {
      await notifySummaryTerminalStatus({
        ...
        deferredMetadata: {
          ...
          promptEvalDurationMs: failureContext?.promptEvalDurationMs ?? null,
          generationDurationMs: failureContext?.generationDurationMs ?? null,
          throughput: failureContext?.throughput ?? null,

...
/** Port the managed TabbyAPI listens on; the test runner guards it against live-instance access. */
export const SIFT_DEFAULT_ENGINE_PORT = 8098;
export const SIFT_DEFAULT_ENGINE_BASE_URL = `http://127.0.0.1:${SIFT_DEFAULT_ENGINE_PORT}`;
/** Prompt ingestion chunk size (TabbyAPI `chunk_size`). */
export const SIFT_DEFAULT_ENGINE_UBATCH_SIZE = 512;
export const SIFT_DEFAULT_ENGINE_CACHE_RAM = 8192;
...
export const SIFT_DEFAULT_ENGINE_KV_CACHE_QUANTIZATION = 'f16';
export const SIFT_DEFAULT_ENGINE_REASONING_BUDGET = 10_000;
export const SIFT_DEFAULT_ENGINE_REASONING_BUDGET_MESSAGE = 'Thinking budget exhausted. You have to provide the answer now.';
export const SIFT_DEFAULT_ENGINE_SLEEP_IDLE_SECONDS = 600;
...
export const RUNTIME_OWNED_ENGINE_KEYS = [
  'BaseUrl',
  'NumCtx',
  'ModelPath',
  'Temperature',
...
export type RuntimeOwnedEngineKey = typeof RUNTIME_OWNED_ENGINE_KEYS[number];
